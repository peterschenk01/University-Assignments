...
class MLPPolicySL(BasePolicy, nn.Module, metaclass=abc.ABCMeta):
    ...
    def forward(self, observation: torch.FloatTensor) -> Any:
        ...
        assert sampled_action.shape[0] == observation.shape[0], "Sampled action and observation must have the same batch size"
    ...
    def update(self, observations, actions):
        ...
        sampled_actions = self(observations)
        assert sampled_actions.shape == actions.shape, "Sampled actions and actions must have the same shape"
